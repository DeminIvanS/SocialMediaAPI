...
import example.model.dto.request.CommentRequest;
...
public class CommentsControllerTest {
    ...
    public void createComment() throws Exception {
        ...
        CommentRequest rq = CommentRequest.builder().commentMessage("Added in test comment to post 1").build();
    ...
    public void editComment() throws Exception {
        ...
        CommentRequest rq = CommentRequest.builder().commentMessage("New comment from test to post 1").build();
