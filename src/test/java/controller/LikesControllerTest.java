...
public class LikesControllerTest {
    ...
    public void putLike() throws Exception {
        ...
        LikeRequest request = LikeRequest.builder().type("Post").itemId(1).build();
        this.mockMvc.perform(put(likesToPostUrl).content(objectMapper.writeValueAsString(request))
